...
export default function AccordionClass({ titleInput, content, setContentClass, onDelete, contentClass }: IProps) {
				...
				<AccordionItem>
					...
					<AccordionPanel pb={4}>
						<Flex marginBottom={5} gap={5}>
							<Input variant='outline' bg='white' placeholder='Digite a URL do vídeo' onChange={(e) => addUrlVideo(e)} />
							<Input variant='outline' bg='white' placeholder='Digite a URL do PDF' onChange={(e) => addUrlPdf(e)} />
						</Flex>
